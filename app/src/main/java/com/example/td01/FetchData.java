...
import com.example.td01.ListeActivity;
...
public class FetchData extends AsyncTask<Object, Void, JSONObject> {
    ...
    protected void onPostExecute(JSONObject response) {
        if(response != null) {
            Log.i("CIO", "produit: ");
            TextView txt = activity.findViewById(R.id.tvLogin);
            ...
            ListView lvCourses = activity.findViewById(R.id.lvCourses);
